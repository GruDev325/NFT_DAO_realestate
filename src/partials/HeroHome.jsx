      ...
      <div id="headerdiv" className="pt-6 pb-0 md:pt-6 md:pb-0" >
        ...
        <div className="pt-6 pb-12 md:pt-12 md:pb-20" >
          ...
          <div className="text-center pb-12 md:pb-16" /* style={{ backgroundImage: `url(${Background})` }} */>
            <p className="text-xl text-white mb-8" data-aos="zoom-y-out" data-aos-delay="150">READY TO TAKE OVER THE REAL ESTATE BUSINESS AND NFT SPACE</p>
 ...
 */}            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-white mb-8" data-aos="zoom-y-out" data-aos-delay="150">On our 3rd year anniversary in the real estate business, we are commemorating by using 3rd web technology</p>
