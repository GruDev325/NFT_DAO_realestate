...
<img className="md:max-w-none mx-auto rounded" src={FeaturesBg} width="900" height="602" alt="Features bg"  />
            ...
            {/* Tabs items */}
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-12 mb-8 md:mb-0 md:order-1" data-aos="zoom-y-out" ref={tabs}>
