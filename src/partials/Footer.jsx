 ...
 */}              <img className="mx-auto" src={Logo} width="150" height="150" alt="Hero"/>
                  <p style={{textAlign: 'center'}}>Unique By Design Realty 3.0</p>
 ...
 */}
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div className="text-sm text-gray-600 mr-4">© 2022 UNIQUE BY DESIGNE REALITY. ALL RIGHTS RESERVED</div>
        </div>
