...
{/* Copyrights note */}
          ...
          <div id="footerdiv1" class="flex"><img src={Logo} width="100" alt="Hero"/></div>
          <div id="footerdiv2" className="text-sm text-gray-600 mr-4">© 2022 UNIQUE BY DESIGNE REALITY. ALL RIGHTS RESERVED</div>
          {/* Social links */}
          <ul id="footerdiv3" className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
